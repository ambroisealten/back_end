...
public class InitBaseWebService {
	 ...
	 * ATTENTION ! This will populate the database entirely with a preset of datas, thus check if you have a Mongo Repository running
	 * in your PC, and check the result in it
