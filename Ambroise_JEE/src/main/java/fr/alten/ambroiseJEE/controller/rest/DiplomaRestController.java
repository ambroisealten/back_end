...
public class DiplomaRestController {
	...
	@PostMapping("/diploma")
	@ResponseBody
	public HttpException createDiploma(@RequestBody JsonNode params, @RequestAttribute("role") UserRole role) throws ParseException {
	...
	@PutMapping("/diploma")
	@ResponseBody
	public HttpException updateDiploma(@RequestBody JsonNode params, @RequestAttribute("role") UserRole role) throws ParseException {
