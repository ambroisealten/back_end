...
public class TechSkillBusinessController {
	...
	public HttpException createTechSkill(JsonNode jTechSkill, UserRole role) {
		return (UserRole.CDR_ADMIN == role || UserRole.MANAGER_ADMIN == role) ? techSkillEntityController.createTechSkillAndGrade(jTechSkill) : new ForbiddenException();
	}
	...
	public HttpException updateTechSkill(JsonNode jTechSkill, UserRole role) {
		return (UserRole.CDR_ADMIN == role || UserRole.MANAGER_ADMIN == role) ? techSkillEntityController.updateTechSkill(jTechSkill) : new ForbiddenException();
	}
