...
public class ConsultantRestController {
	 ...
	 *         request ({@link ConflictException} if the resource is not found
	 ...
	 * @param role the user's role
	 * @return {@link HttpException} corresponding to the status of the
	 *         request ({@link ResoucreNotFoundException} if the resource is not found
	 *         and {@link OkException} if the person(consultant) is updated
	 * @author Lucas Royackkers
	 ...
	 *         and {@link OkException} if the person(consultant) is deleted
	 * @author Lucas Royackkers
	 */
